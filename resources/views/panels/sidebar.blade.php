    ...
    <h1 class="logo-wrapper">
      <a class="brand-logo darken-1" href="{{asset('/')}}">
        @if(!empty($configData['mainLayoutType']) && isset($configData['mainLayoutType']))
          ...
          <img class="hide-on-med-and-down" src="{{url('/')}}/images/logo/logo.png" alt="materialize logo" style="width: 100%;
    height: auto;
    margin-top: -22px;" />
...
$urlSeg2 = Request::segment(2);
        @endphp
      <li class="bold {{(__('locale.'.$menu->name)) && $menu->name=='Homework' || $menu->name=='Admin' ? "customHomework":''}}  {{(request()->is($menu->url.'*')) ? 'active' : '' }}">
