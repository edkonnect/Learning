                            ...
                            <div class="col m6 s12">
                                ...
                                <div class="input-field">
                                    <select class="select2 browser-default" id="student" name="student" required="1" onchange="return getCourse(this.value);">
                                        ...
                                        <option {{isset($studentID) && $key==$studentID ? 'selected':''}} value="{{$key}}">{{strtoupper($val)}}</option>                                        
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                                ...
                                <div class="col s12 m12 20 indexSessionData">
                                    <div class="card ">
                                        <div class="card-title " style="text-align: center; padding: 10px">
                                            <h5 style="font-weight: bold;">{{isset($getsessionData->topic_name)?strtoupper($getsessionData->topic_name):''}}</h5>
                                        </div>
...
<script>
                                        ...
                                        $.ajax({
                                        type: "get",
                                                url: '{{url("/")}}' + '/getHomeworkAjaxView/' + studentID + '/' + course + '/' + timePeriod,
                                                success: function (data) {
