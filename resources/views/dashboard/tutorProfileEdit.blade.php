                                    ...
                                    <div class="row">
                                        <div class=" col s12 m6">
                                            <div class="card-action " style="text-align: left;">
                                                ...
                                                <p>Education : {{isset($getUserData->email)?$getUserData->email:''}}</p>
                                                <p>No. of years taught this subject : {{isset($getUserData->email)?$getUserData->email:''}}</p>
                                                <p>Experience Summary : {{isset($getUserData->email)?$getUserData->email:''}}</p>
                                                <!--</div>-->
                                        ...
                                        <div class=" col s12 m6">
                                            <div class="card-action " style="text-align: right;">
                                                <a class="waves-effect waves-cyan mb-2 mr-1 " href="{{url('tutor/tutorProfileEdit')}}">
