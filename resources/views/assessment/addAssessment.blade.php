...
<div class="section">
    ...
    <section class="snow-editor">
      ...
      @endif
                      <form method="post" action="{{ url('/save-assessment') }}">
                       {{ csrf_field() }}
