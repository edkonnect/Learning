          ...
          <h1 class="logo-wrapper">
            <a class="brand-logo darken-1" href="<?php echo e(asset('/')); ?>">
              ...
              <span class="logo-text hide-on-med-and-down">
                <?php if(!empty ($configData['templateTitle'])): ?>
      ...
      <ul class="left hide-on-med-and-down" id="ul-horizontal-nav" data-menu="menu-navigation">
        ...
        <?php if(!empty($menuData[1]) && isset($menuData[1])): ?>
          <?php $__currentLoopData = $menuData[1]->menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            ?>
          <li>
            <a <?php if(isset($menu->submenu)): ?><?php echo e('class=dropdown-menu'); ?> <?php endif; ?> href="<?php echo e($menu->url); ?>" data-target="<?php echo e($menu->activate); ?>">
              <i class="material-icons"><?php echo e($menu->icon); ?></i>
              <span>
                <span class="dropdown-title"><?php echo e(__('locale.'.$menu->name)); ?></span>
            ...
            <?php if(isset($menu->submenu)): ?>
              <?php echo $__env->make('panels.horizontalSubmenu',['menu' => $menu->submenu],['activate'=>$menu->activate], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
          </li>
...
<ul class="display-none" id="default-search-main">
  ...
  <li class="auto-suggestion"><a class="collection-item" href="#">
      <div class="display-flex">
        <div class="display-flex align-item-center flex-grow-1">
          <div class="avatar"><img src="<?php echo e(asset('images/icon/pdf-image.png')); ?>" width="24" height="30"
              alt="sample image">
          </div>
  ...
  <li class="auto-suggestion"><a class="collection-item" href="#">
      <div class="display-flex">
        <div class="display-flex align-item-center flex-grow-1">
          <div class="avatar"><img src="<?php echo e(asset('images/icon/doc-image.png')); ?>" width="24" height="30"
              alt="sample image">
          </div>
  ...
  <li class="auto-suggestion"><a class="collection-item" href="#">
      <div class="display-flex">
        <div class="display-flex align-item-center flex-grow-1">
          <div class="avatar"><img src="<?php echo e(asset('images/icon/xls-image.png')); ?>" width="24" height="30"
              alt="sample image">
          </div>
  ...
  <li class="auto-suggestion"><a class="collection-item" href="#">
      <div class="display-flex">
        <div class="display-flex align-item-center flex-grow-1">
          <div class="avatar"><img src="<?php echo e(asset('images/icon/jpg-image.png')); ?>" width="24" height="30"
              alt="sample image">
          </div>
  ...
  <li class="auto-suggestion"><a class="collection-item" href="#">
      <div class="display-flex">
        <div class="display-flex align-item-center flex-grow-1">
          <div class="avatar"><img class="circle" src="<?php echo e(asset('images/avatar/avatar-7.png')); ?>" width="30"
  ...
  <li class="auto-suggestion"><a class="collection-item" href="#">
      <div class="display-flex">
        <div class="display-flex align-item-center flex-grow-1">
          <div class="avatar"><img class="circle" src="<?php echo e(asset('images/avatar/avatar-8.png')); ?>" width="30"
              alt="sample image"></div>
  ...
  <li class="auto-suggestion"><a class="collection-item" href="#">
      <div class="display-flex">
        <div class="display-flex align-item-center flex-grow-1">
          <div class="avatar"><img class="circle" src="<?php echo e(asset('images/avatar/avatar-10.png')); ?>" width="30"
              alt="sample image"></div>
  ...
  <li class="auto-suggestion"><a class="collection-item" href="#">
      <div class="display-flex">
        <div class="display-flex align-item-center flex-grow-1">
          <div class="avatar"><img class="circle" src="<?php echo e(asset('images/avatar/avatar-12.png')); ?>" width="30"
              alt="sample image"></div>
          <div class="member-info display-flex flex-column"><span class="black-text">Anna Strong</span><small
              class="grey-text">Web Designer</small></div>
        </div>
...
</ul><?php /**PATH C:\xampp\htdocs\edkonnect\resources\views\panels\horizontalNavbar.blade.php ENDPATH**/ ?>