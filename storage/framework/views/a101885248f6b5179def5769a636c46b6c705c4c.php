    ...
    <div class=" col s12 m12 20 indexSessionData">
        <div class=" card ">
            ...
            <div class=" card-content " style="text-align: center;">
                ...
                <p style="text-align: center;"><a target="_blank" href="<?php echo e(url('/tutor/getHomework',['session_id' => $vals->id,'student_id'=>$vals->student_id,'course_id'=>$vals->course_id])); ?>" class="waves-effect waves-light btn" style="background-color: #736cb5;    margin-top: 20px;">Click here for Homework</a></p>
            </div>
            <!--            <div class=" card-alert card " style="background-color: #8862b5;">
                            <div class=" row">
...
</script><?php /**PATH C:\xampp\htdocs\edkonnect\resources\views\session\sessionTutorDetailView.blade.php ENDPATH**/ ?>