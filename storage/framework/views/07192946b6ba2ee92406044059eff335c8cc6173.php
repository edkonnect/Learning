...
<div class="section">
  <div class="row user-profile mt-1 ml-0 mr-0">
    <img class="responsive-img" alt="" src="<?php echo e(asset('images/gallery/profile-bg')); ?>.png">
  </div>
      ...
      <div class="col s12 m4 l3 user-section-negative-margin">
        <div class="row">
          <div class="col s12 center-align">
            <img class="responsive-img circle z-depth-5" width="120" src="<?php echo e(asset('images/user/12.jpg')); ?>" alt="">
            <br>
        ...
        <div class="row user-projects">
          ...
          <div class="col s4">
            <img class="responsive-img photo-border mt-10" alt="" src="<?php echo e(asset('images/gallery/35.png')); ?>">
          </div>
          <div class="col s4">
            <img class="responsive-img photo-border mt-10" alt="" src="<?php echo e(asset('images/gallery/36.png')); ?>">
          </div>
          <div class="col s4">
            <img class="responsive-img photo-border mt-10" alt="" src="<?php echo e(asset('images/gallery/37.png')); ?>">
          </div>
          <div class="col s4">
            <img class="responsive-img photo-border mt-10" alt="" src="<?php echo e(asset('images/gallery/38.png')); ?>">
          </div>
          <div class="col s4">
            <img class="responsive-img photo-border mt-10" alt="" src="<?php echo e(asset('images/gallery/39.png')); ?>">
          </div>
          <div class="col s4">
            <img class="responsive-img photo-border mt-10" alt="" src="<?php echo e(asset('images/gallery/40.png')); ?>">
          </div>
          <div class="col s4">
            <img class="responsive-img photo-border mt-10" alt="" src="<?php echo e(asset('images/gallery/41.png')); ?>">
          </div>
          <div class="col s4">
            <img class="responsive-img photo-border mt-10" alt="" src="<?php echo e(asset('images/gallery/42.png')); ?>">
          </div>
          <div class="col s4">
            <img class="responsive-img photo-border mt-10" alt="" src="<?php echo e(asset('images/gallery/43.png')); ?>">
          </div>
        </div>
        <hr class="mt-5">
        <div class="row">
        ...
        <div class="row mt-2">
          <div class="col s2 mt-2 pr-0 circle">
            <a href="#"><img class="responsive-img circle" src="<?php echo e(asset('images/user/1.jpg')); ?>" alt=""></a>
          </div>
          <div class="col s9">
            <a href="#">
        ...
        <div class="row mt-2">
          <div class="col s2 mt-2 pr-0 circle">
            <a href="#"><img class="responsive-img circle" src="<?php echo e(asset('images/user/11.jpg')); ?>" alt=""></a>
          </div>
          <div class="col s9">
            <a href="#">
        ...
        <div class="row mt-2">
          <div class="col s2 mt-2 pr-0 circle">
            <a href="#"><img class="responsive-img circle" src="<?php echo e(asset('images/user/5.jpg')); ?>" alt=""></a>
          </div>
          <div class="col s9">
            <a href="#">
        ...
        <div class="row mt-2">
          <div class="col s2 mt-2 pr-0 circle pb-2">
            <a href="#"><img class="responsive-img circle" src="<?php echo e(asset('images/user/8.jpg')); ?>" alt=""></a>
          </div>
          <div class="col s9">
            <a href="#">
            ...
            <div class="card-content card-border-gray">
              ...
              <div class="row mt-5">
                <div class="col s1 pr-0 circle">
                  <a href="#"><img class="responsive-img circle" src="<?php echo e(asset('images/user/12.jpg')); ?>" alt=""></a>
                </div>
                <div class="col s11">
                  <a href="#">
                    ...
                    <div class="col s12">
                      <div class="card card-border z-depth-2">
                        <div class="card-image">
                          <img src="<?php echo e(asset('images/gallery/post-1')); ?>.png" alt="">
                        </div>
                ...
                <div class="col s11">
                  ...
                  <div class="row">
                    <div class="col s12">
                      <div class="card card-border z-depth-2">
                        <div class="card-image">
                          <img src="<?php echo e(asset('images/gallery/post-2')); ?>.png" alt="">
                        </div>
                        <div class="card-content">
              ...
              <div class="row mt-5">
                <div class="col s1 pr-0 circle">
                  <a href="#"><img class="responsive-img circle" src="<?php echo e(asset('images/user/7.jpg')); ?>" alt=""></a>
                </div>
                <div class="col s11">
                  <a href="#">
                        ...
                        <div class="card-content">
                          <div class="row">
                            <div class="col s2 pr-0 circle">
                              <a href="#"><img class="responsive-img circle" src="<?php echo e(asset('images/user/1.jpg')); ?>"
                                  alt=""></a>
                            </div>
                            <div class="col s10">
                              <a href="#">
      ...
      <div class="col s12 m12 l3 hide-on-med-and-down">
        <div class="row mt-5">
          <div class="col s12">
            ...
            <img class="responsive-img card-border z-depth-2 mt-2" src="<?php echo e(asset('images/gallery/post-3')); ?>.png" alt="">
        ...
        <div class="row mt-2">
          <div class="col s2 mt-2 pr-0 circle">
            <a href="#"><img class="responsive-img circle" src="<?php echo e(asset('images/user/2.jpg')); ?>" alt=""></a>
          </div>
          <div class="col s9">
            <a href="#">
        ...
        <div class="row mt-2">
          <div class="col s2 mt-2 pr-0 circle">
            <a href="#"><img class="responsive-img circle" src="<?php echo e(asset('images/user/4.jpg')); ?>" alt=""></a>
          </div>
          <div class="col s9">
            <a href="#">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\edkonnect\resources\views\pages\user-profile-page.blade.php ENDPATH**/ ?>