<?php $__env->startSection('title', 'eCommerce Products Page'); ?>


<?php $__env->startSection('vendor-style'); ?>
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendors/noUiSlider/nouislider.min.css')); ?>">
<?php $__env->stopSection(); ?>


<?php $__env->startSection('page-style'); ?>
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/pages/eCommerce-products-page.css')); ?>">
<?php $__env->stopSection(); ?>
      ...
      <div class="col s12 m4 l4">
        <div class="card animate fadeLeft">
          ...
          <div class="card-content">
            ...
            <img src="<?php echo e(asset('images/cards/watch-2.png')); ?>" class="responsive-img" alt="">
      ...
      <div class="col s12 m4 l4">
        <div class="card animate fadeUp">
          <div class="card-content">
            ...
            <img src="<?php echo e(asset('images/cards/headphone.png')); ?>" class="responsive-img" alt="">
            <div class="display-flex flex-wrap justify-content-center">
      ...
      <div class="col s12 m4 l4">
        <div class="card animate fadeRight">
          <div class="card-content">
            ...
            <img src="<?php echo e(asset('images/cards/iphone-x.png')); ?>" class="responsive-img" alt="">
            <div class="display-flex flex-wrap justify-content-center">
        ...
        <div class="card animate fadeUp">
          ...
          <div class="card-content">
            <div class="row" id="product-four">
              <div class="col m6 s12">
                <img src="<?php echo e(asset('images/cards/remote.png')); ?>" class="responsive-img" alt="">
              </div>
              <div class="col m6 s12">
                <p>Powerbank</p>
                <h5>Game Remote</h5>
        ...
        <div class="col s12 m4 l4">
          <div class="card animate fadeLeft">
            <div class="card-content">
              ...
              <img src="<?php echo e(asset('images/cards/powerbank.png')); ?>" class="responsive-img" alt="">
              <div class="display-flex flex-wrap justify-content-center">
        ...
        <div class="col s12 m4 l4">
          <div class="card animate fadeUp">
            ...
            <div class="card-content">
              ...
              <img src="<?php echo e(asset('images/cards/speakers.png')); ?>" class="responsive-img" alt="">
              <div class="display-flex flex-wrap justify-content-center">
        ...
        <div class="col s12 m4 l4">
          <div class="card animate fadeRight">
            <div class="card-content">
              ...
              <img src="<?php echo e(asset('images/cards/cameras.png')); ?>" class="responsive-img" alt="">
              <div class="display-flex flex-wrap justify-content-center">
        ...
        <div class="col s12 m4 l4">
          <div class="card animate fadeLeft">
            <div class="card-content">
              ...
              <img src="<?php echo e(asset('images/cards/oneplus-6t.png')); ?>" class="responsive-img" alt="">
              <div class="display-flex flex-wrap justify-content-center">
        ...
        <div class="col s12 m4 l4">
          <div class="card animate fadeUp">
            <div class="card-content">
              ...
              <img src="<?php echo e(asset('images/cards/smartspeakers.png')); ?>" class="responsive-img" alt="">
              <div class="display-flex flex-wrap justify-content-center">
        ...
        <div class="col s12 m4 l4">
          <div class="card animate fadeRight">
            <div class="card-content">
              ...
              <img src="<?php echo e(asset('images/cards/magic-mouse.png')); ?>" class="responsive-img" alt="">
              <div class="display-flex flex-wrap justify-content-center">
...
<script src="<?php echo e(asset('js/scripts/eCommerce-products-page.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\edkonnect\resources\views\pages\eCommerce-products-page.blade.php ENDPATH**/ ?>