    ...
    <section class="snow-editor">
                            ...
                            <div class="col m6 s12">
                                <div class="card-title ">
                                    <h5 style="font-weight: bold;
                                        color: #8b62b5;">COMPLETED ASSESSMENTS</h5></div>
                            </div>
                        </div>
                    </div>
        ...
        <th>Result</th>
                       ...
                       <tbody id ="Assessment">
                         ...
                         <tr>
      <td><?php echo e(strtoupper($val->topic_name)); ?></td>
      <td><?php echo e(Carbon\Carbon::parse($val->assessment_taken_date)->format(' jS  F Y ')); ?></td>
      <td><?php echo e($val->points); ?></td>
      <td >

          <a href="<?php echo e(url($val->location.$val->result_pdf)); ?>"
             >Result</a>
            ...
            type: "post",
                    ...
                    $('#course').html(data);
                                        ...
                                        data:{'studentID':studentID, 'course':course, '_token': '<?php echo e(csrf_token()); ?>'},
                                                type: "post",
                                                url: '<?php echo e(url("/")); ?>' + '/assessment/completedView',
                                                success: function (data) {
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n614h8do5jis/public_html/V/app/edkonnect/resources/views/assessment/CompletedAssessment.blade.php ENDPATH**/ ?>