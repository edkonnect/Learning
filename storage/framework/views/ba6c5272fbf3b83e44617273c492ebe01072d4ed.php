    ...
    <h1 class="logo-wrapper">
      <a class="brand-logo darken-1" href="<?php echo e(asset('/')); ?>">
        <?php if(!empty($configData['mainLayoutType']) && isset($configData['mainLayoutType'])): ?>
          ...
          <img class="hide-on-med-and-down" src="<?php echo e(url('/')); ?>/images/logo/logo.png" alt="materialize logo" style="width: 100%;
    height: auto;
    margin-top: -22px;" />
...
<!--        <span class="logo-text hide-on-med-and-down">
  ...
  <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out"
      data-menu="menu-navigation" data-collapsible="menu-accordion" style="margin-top:20px !important;">
...
$urlSeg2 = Request::segment(2);
        ?>
      <li class="bold <?php echo e((__('locale.'.$menu->name)) && $menu->name=='Homework' || $menu->name=='Admin' ? "customHomework":''); ?>  <?php echo e((request()->is($menu->url.'*')) ? 'active' : ''); ?>">
...
</aside><?php /**PATH /home/n614h8do5jis/public_html/V/app/edkonnect1/resources/views/panels/sidebar.blade.php ENDPATH**/ ?>