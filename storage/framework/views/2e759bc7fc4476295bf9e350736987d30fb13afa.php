            ...
            <tbody>                    
                ...
                <tr>
                    ...
                    <td style="text-align: center">
                        <a href="<?php echo e(url("/")); ?>/uploads/<?php echo e($parentUserName->username . '/' . $studUserName->username.'/'.$val->attachment_link); ?>" target="_blank" class="waves-effect waves-light btn" style="background-color: #736cb5;">View</a>
                    </td>
                    <td style="text-align: center">
...
<?php /**PATH C:\xampp\htdocs\edkonnect\resources\views\homework\uploadList.blade.php ENDPATH**/ ?>