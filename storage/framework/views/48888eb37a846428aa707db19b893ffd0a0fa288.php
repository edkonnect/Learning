                        ...
                        <div class="col m2 s12">
                            <div class="card-title ">
                                <h5 style="font-weight: bold;color: #8b62b5;text-align: right;">
                                    <a href="<?php echo e(url('/')); ?>/messages" class="waves-effect waves-light btn modal-trigger mb-2 mr-1" style="background-color: #736cb5;">Back</a></h5></div>
                        </div>
                    </div>
                                        ...
                                        <div class="card" style="box-shadow: 1px 2px 10px #999;border-radius: 20px;">
                                            ...
                                            <div class="row">
                                                <div class="col s12 m12 20">
                                                    <div class="card-action " style="text-align: right;">
                                                        <h6 style="font-weight: bold;color: #8b62b5;">Date Time : <?php echo e(Carbon\Carbon::parse($getData->date_time)->format(' jS  F Y H:i:s')); ?></h6>
                                                    </div>
                                                </div>
                                            </div>
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n614h8do5jis/public_html/V/app/edkonnect/resources/views/messages/show.blade.php ENDPATH**/ ?>