...
<div class="row sessionNotesData">
    ...
    <div class="col s12 m12 20 indexSessionData">
        <div class="card ">
            ...
            <?php if(count($vals->getStudHWAttachmentDetail)>0): ?>
            <div class="card-content">
                <div class=" row">
                    <?php $__currentLoopData = $vals->getStudHWAttachmentDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyAttach=>$valAttch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                    <div class=" col s12 m3">
                        <div class=" card-action" style="text-align: center">
                            Homework - <?php echo e($keyAttach+1); ?>

                            <a href="<?php echo e(url("/")); ?>/uploads/<?php echo e($vals->getStudentDetail->username.'/'.$vals->getTutorDetail->username.'/'.$valAttch->attachment_link); ?>" target="_blank" class="waves-effect waves-light btn" style="background-color: #736cb5;">Download</a>
                        </div>
                    </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\edkonnect\resources\views\homework\homeworkTutorListDetailView.blade.php ENDPATH**/ ?>