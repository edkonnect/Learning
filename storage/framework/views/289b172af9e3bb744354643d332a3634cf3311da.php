...
<?php $__env->startSection('title','Add Tutor'); ?>
...
<div class="section">
    ...
    <?php endif; ?>
                    <div class="card-content">
                          ...
                          <form name="myform" method="post" action="<?php echo e(url('/add-tutor/store')); ?>">
                             ...
                             <div class="row">
                               <div class="col m6 s12">
                                   <h5>Select Course</h5>
                                   <div class="input-field">
                                     <select name ="course[]" id="myselect" multiple class="select2 browser-default">
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n614h8do5jis/public_html/V/app/edkonnect/resources/views/RegisterUser/AddTutor.blade.php ENDPATH**/ ?>