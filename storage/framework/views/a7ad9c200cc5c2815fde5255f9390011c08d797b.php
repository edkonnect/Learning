...
<div class="chat-application">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col s12 m4 20">
                                            <div class="card-action " style="text-align: right;">
                                                <h6 style="font-weight: bold;color: #8b62b5;">Date Time : <?php echo e(isset($getData->date)?$getData->date.' '.$getData->time:''); ?></h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="chats">
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n614h8do5jis/public_html/V/app/edkonnect1/resources/views/messages/show.blade.php ENDPATH**/ ?>