    ...
    <div class="col s12 m12 l12">
        <div id="Form-advance" class="card card card-default scrollspy">
            ...
            <div class="card-content">
              <form method="POST" action="<?php echo e(url('tutor-homework-list/uploadFile')); ?>" accept-charset="UTF-8" enctype="multipart/form-data" id="uploadFileForm" name="uploadFileForm">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col m8 s12">
                          ...
                          <input type="hidden" id="tutor_id" name="tutor_id" value="<?php echo e(Auth::user()->id); ?>" />
                        </div>
            ...
            <div  >
              <div class="row">
                  <div class="card-action">
                      ...
                      <table  class="display">
                        <?php if(isset($getListing) && count($getListing) > 0): ?>
                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td style="text-align: center"><?php echo e($val->filename); ?></td>
                                  <td><?php echo e(Carbon\Carbon::parse($val->created_at)->format(' jS  F Y ')); ?></td>

                                  <td style="text-align: center">
                                    <a href="<?php echo e(url($val->location.$val->filename)); ?>"target="_blank" class="waves-effect waves-light btn" style="background-color: #736cb5;">View
                                       </a>
                                  </td>
                                  <td style="text-align: center">
...
var deleteID = val;
$.ajax({
url: '<?php echo e(url("/")); ?>' + '/tutor-homework-list/destroy',
        type: "POST",
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n614h8do5jis/public_html/V/app/edkonnect/resources/views/homework/TutorFiles.blade.php ENDPATH**/ ?>