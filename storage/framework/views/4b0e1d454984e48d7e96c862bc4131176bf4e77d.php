<?php $__env->startSection('title','App Invoice View' ); ?>
        ...
        <div class="card-content invoice-print-area">
          ...
          <div class="row mt-3 invoice-logo-title">
            <div class="col m6 s12 display-flex invoice-logo mt-1 push-m6">
              <img src="<?php echo e(asset('images/logo/logo.png')); ?>" alt="logo" height="46" width="164">
            </div>
          ...
          <div class="row invoice-info">
            ...
            <div class="col m6 s12">
              ...
              <div class="invoice-address">
                <span>Edkonnect PVT. LTD.</span>
              </div>
              <div class="invoice-address">
                <span>203 Sussex St. Suite B Waukegan, IL 60085</span>
              </div>
              <div class="invoice-address">
                <span>edkonnect@gmail.com</span>
              </div>
              <div class="invoice-address">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\edkonnect\resources\views\dashboard\app-invoice-view.blade.php ENDPATH**/ ?>