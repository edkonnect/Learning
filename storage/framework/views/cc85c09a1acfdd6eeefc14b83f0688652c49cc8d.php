...
<?php
//echo '<pre>';
//print_r($getsessionData->getHWAttachmentDetail);
//die;
?>
                            ...
                            <div class="col m6 s12">
                                <div class="card-title ">
                                    <h5 style="font-weight: bold;
                                        color: #8b62b5;">Homework</h5></div>
                            </div>
                            <div class="col m3 float-right">
                                <?php $getTimePeriod = array("2" => "This Month", "3" => "This Week", "4" => "Last Week", "5" => "Last Month", "6" => "View All"); ?>
                                <select class="select2 browser-default" id="timePeriod" name="timePeriod" onchange="return getHomework(this.value);">
                    ...
                    <div class="card-content">
                        ...
                        <div class="row">
                            <div class="col m6 s12">
                                ...
                                <div class="input-field">
                                    <select class="select2 browser-default" id="student" name="student" required="1" onchange="return getCourse(this.value);">
                                        ...
                                        <option <?php echo e(isset($studentID) && $key==$studentID ? 'selected':''); ?> value="<?php echo e($key); ?>"><?php echo e(strtoupper($val)); ?></option>                                        
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </select>
                                </div>
                            ...
                            <div class="col m6 s12">
                                <h5>Course</h5>
                                <div class="input-field">
                                    <select class="select2 browser-default" id="course" required="1" onchange="return getHomework(this.value);">
                                ...
                                <div class="col s12 m12 20 indexSessionData">
                                    <div class="card ">
                                        <div class="card-title " style="text-align: center; padding: 10px">
                                            <h5 style="font-weight: bold;"><?php echo e(isset($getsessionData->topic_name)?strtoupper($getsessionData->topic_name):''); ?></h5>
                                        </div>
...
<script>
                                        ...
                                        $.ajax({
                                        type: "get",
                                                url: '<?php echo e(url("/")); ?>' + '/getHomeworkAjaxView/' + studentID + '/' + course + '/' + timePeriod,
                                                success: function (data) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n614h8do5jis/public_html/V/app/edkonnect1/resources/views/homework/homework.blade.php ENDPATH**/ ?>