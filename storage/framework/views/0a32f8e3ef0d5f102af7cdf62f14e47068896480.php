...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/pages/app-email-content.css')); ?>">
<?php $__env->stopSection(); ?>
              ...
              <div class="email-header">
                <div class="subject">
                  <div class="back-to-mails">
                    <a href="<?php echo e(asset('app-email')); ?>"><i class="material-icons">arrow_back</i></a>
                  </div>
                ...
                <div class="footer-action">
                  <div class="attachment-list">
                    <div class="attachment">
                      <img src="<?php echo e(asset('images/gallery/35.png')); ?>" alt="" class="responsive-img attached-image">
                      <div class="size">
                    ...
                    <div class="attachment">
                      <img src="<?php echo e(asset('images/gallery/36.png')); ?>" alt="" class="responsive-img attached-image">
                      <div class="size">
                    ...
                    <div class="attachment">
                      <img src="<?php echo e(asset('images/gallery/39.png')); ?>" alt="" class="responsive-img attached-image">
                      <div class="size">
...
<script src="<?php echo e(asset('js/scripts/app-email-content.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\edkonnect\resources\views\pages\app-email-content.blade.php ENDPATH**/ ?>