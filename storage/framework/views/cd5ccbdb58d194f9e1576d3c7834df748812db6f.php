            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 login-sec">
                        ...
                        <form class="form" method="POST" action="<?php echo e(url('temp-login/store')); ?>">

                                <img src="<?php echo e(url('/')); ?>/images/logo/logo.png" alt="Edkonnect logo" class="header-brand-img desktop-lgo" style="margin-top:-40px !important;width: 100%;">
                                ...
                                <div class="form-group">
                                    <label class="text-uppercase" for="exampleInputEmail1"><?php echo e(__('E-Mail Address')); ?></label>
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        ...
                                        <small><?php echo e(__('Remember Me')); ?></small>
                                    </label>
                                    ...
                                    <a class="btn btn-link" style="text-decoration:none;" href="<?php echo e(route('password.request')); ?>">
                    ...
                    <div class="col-md-8 banner-sec">
                        <div class="carousel-item">
                            <img alt="First slide" class="d-block img-fluid" src="<?php echo e(url('/')); ?>/uploads/login/people-coffee-tea-meeting.jpg">
...
<?php /**PATH /home/n614h8do5jis/public_html/V/app/edkonnect1/resources/views/RegisterUser/TempLogin.blade.php ENDPATH**/ ?>