                            ...
                            <div class="row sessionNotesData">
                                ...
                                <div class="col s12 m12 20 indexSessionData">
                                    <div class="card ">
                                        ...
                                        <?php if(count($val->getHWAttachmentDetail)>0): ?>
                                        <div class="card-content">
                                            <div class=" row">
                                                <?php $__currentLoopData = $val->getHWAttachmentDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyAttach=>$valAttch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n614h8do5jis/public_html/V/app/edkonnect1/resources/views/homework/index.blade.php ENDPATH**/ ?>