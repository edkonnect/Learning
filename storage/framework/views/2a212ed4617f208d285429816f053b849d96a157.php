                ...
                <div class="card">
                    ...
                    <div class="row" style="margin-top:60px;">
                        ...
                        <div class="input-field col m6 s6">
                            <label>
                                <a href= "<?php echo e(url('/').'/ELAGR7-10/'.$fileNames); ?>" ><?php echo e($fileNames); ?></a>
                            </label>
                        </div>
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n614h8do5jis/public_html/V/app/edkonnect1/resources/views/grade/grade7-10.blade.php ENDPATH**/ ?>