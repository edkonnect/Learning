      ...
      <div id="general">
        <div class="card-panel">
          <div class="display-flex">
            <div class="media">
              <img src="<?php echo e(asset('images/avatar/avatar-12.png')); ?>" class="border-radius-4" alt="profile image"
                height="64" width="64">
            </div>
...
<script src="<?php echo e(asset('js/scripts/page-account-settings.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\edkonnect\resources\views\pages\page-account-settings.blade.php ENDPATH**/ ?>