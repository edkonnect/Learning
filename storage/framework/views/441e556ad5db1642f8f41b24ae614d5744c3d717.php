                                ...
                                <div class="card-content">
                                    <div class="row">
                                        <div class=" col s12 m12">
                                            <div class="row">
                                                <div class=" col s12 m10">
                                                    <div class="col s2 pr-0 circle">
                                                        ...
                                                        <img class="responsive-img circle" style="border-radius: inherit;" width="120" src="<?php echo e(isset($getUserData->profile_image) && $getUserData->profile_image!='' ? url('/').'/uploads/'.$getUserData->username.'/profile_image/'.$getUserData->profile_image:''); ?>" alt="">                       
                                                        <?php else: ?>
                                                        <img class="responsive-img circle" style="border-radius: inherit;" width="120" src="<?php echo e(url('/')); ?>/assets/images/user/default.jpg" alt="">
                                                        <?php endif; ?> 
                                                    </div>
                                                    <div class="col s10">
                                                        <h6><?php echo e(isset($getUserData->name)?strtoupper($getUserData->name):''); ?></h6>
                                                        <p class="m-0"><?php echo e(isset($getUserData->getRoles->name)?strtoupper($getUserData->getRoles->name):''); ?></p>
                                                        <p class="m-0"><?php echo e(isset($getUserData->phone)?$getUserData->phone:''); ?></p>
                                                        <p class="m-0"><?php echo e(isset($getUserData->email)?$getUserData->email:''); ?></p>
                                                ...
                                                <div class=" col s12 m2">
                                                    <a class="waves-effect waves-cyan mb-2 mr-1 " title="Edit Profile" href="<?php echo e(url('tutor/tutorProfileEdit',['id'=>Auth::user()->id])); ?>">
                                            ...
                                            <p><?php echo e(isset($getUserData->education_qualification)?$getUserData->education_qualification:''); ?></p>
                                            <hr>
                                            ...
                                            <p><?php echo e(isset($getUserData->no_of_years_taught)?$getUserData->no_of_years_taught.' Yrs':''); ?></p>
                                            <hr>
                                            <h6 class="font-weight-900 text-uppercase"><a href="javascript:void(0)" style="pointer-events: none;">Experience Summary</a></h6>
                                            <p><?php echo e(isset($getUserData->experience_summary)?$getUserData->experience_summary:''); ?></p>
                                            <hr>
                                            <?php if(isset($getUserData->resume) && $getUserData->resume!=''): ?>
                                            <h6 class="font-weight-900 text-uppercase"><a target="_blank" title="Click to view" href="<?php echo e(url('/').'/uploads/'.Auth::user()->username.'/resume/'.$getUserData->resume); ?>">Resume</a></h6>
                                            <p><embed src="<?php echo e(url('/').'/uploads/'.Auth::user()->username.'/resume/'.$getUserData->resume); ?>" width= "500" height= "200"></p>
                                            <?php else: ?>
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n614h8do5jis/public_html/V/app/edkonnect/resources/views/dashboard/user-profile-tutor.blade.php ENDPATH**/ ?>