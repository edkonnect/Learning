                                ...
                                <div class="col s12 m12 20 indexSessionData">
                                    <div class="card ">
                                        ...
                                        <div class="card-content " style="text-align: center;">
                                            ...
                                            <p style="text-align: center;"><a target="_blank" href="<?php echo e(url('/tutor/getHomework',['session_id' => $val->id,'student_id'=>$val->student_id,'course_id'=>$val->course_id])); ?>" class="waves-effect waves-light btn" style="background-color: #736cb5;    margin-top: 20px;">Click here for Homework</a></p>
                                        </div>
...
<script>
                                        ...
                                        $.ajax({
                                        type: "post",
                                                url: '<?php echo e(url("/")); ?>' + '/session-notes/tutor/getSession',
                                                data: {'course_id': '','userID':'<?php echo Auth::user()->id; ?>', 'timePeriod': timePeriod, 'studentID': studentID, '_token': '<?php echo e(csrf_token()); ?>'},
                                                success: function (data) {
                                        ...
                                        type: "post",
                                                url: '<?php echo e(url("/")); ?>' + '/session-notes/tutor/getSession',
                                                data: {'course_id': course,'userID':'<?php echo Auth::user()->id; ?>', 'studentID': studentID, 'timePeriod': timePeriod, '_token': '<?php echo e(csrf_token()); ?>'},
                                                success: function (data) {
                                        ...
                                        $.ajax({
                                        type: "post",
                                                url: '<?php echo e(url("/")); ?>' + '/session-notes/tutor/getTimePeriodData',
                                                data: {'timePeriod': val,'userID':'<?php echo Auth::user()->id; ?>', 'studentID': studentID, 'course': course, '_token': '<?php echo e(csrf_token()); ?>'},
                                                success: function (data) {
                                                console.log(data);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\edkonnect\resources\views\session\tutorview.blade.php ENDPATH**/ ?>