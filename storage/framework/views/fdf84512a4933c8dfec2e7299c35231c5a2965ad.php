...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/pages/page-search.css')); ?>">
            ...
            <div class="card-content">
              ...
              <div class="row">
                        ...
                        <div class="col s12">
                          <div class="card z-depth-0 grey lighten-4 border-radius-6">
                            <div class="card-image">
                              <img src="<?php echo e(asset('images/gallery/18.png')); ?>" class="responsive-img" alt="">
                            </div>
                            <div class="card-content">
                    ...
                    <div class="col l4 m4 s12">
                      <div class="row">
                        <div class="col s12">
                          <div class="card z-depth-0 grey lighten-4 border-radius-6">
                            <div class="card-image">
                              <img src="<?php echo e(asset('images/gallery/19.png')); ?>" class="responsive-img" alt="">
                            </div>
                            <div class="card-content">
                    ...
                    <div class="col l4 m4 s12">
                      <div class="row">
                        <div class="col s12">
                          <div class="card z-depth-0 grey lighten-4 border-radius-6">
                            <div class="card-image">
                              <img src="<?php echo e(asset('images/gallery/20.png')); ?>" class="responsive-img" alt="">
                            </div>
                            <div class="card-content">
                  ...
                  <div class="result mt-5">
                    <div class="row">
                      <div class="col s12 m3 l3">
                        <img class="responsive-img mt-4 p-3 border-radius-6" src="<?php echo e(asset('images/gallery/37.png')); ?>"
                          alt="">
                      </div>
                ...
                <div class="col l4 m12 right-content border-radius-6 mb-5">
                  ...
                  <img class="responsive-img mt-4 p-3 border-radius-6" src="<?php echo e(asset('images/gallery/34.png')); ?>" alt="">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\edkonnect\resources\views\pages\page-search.blade.php ENDPATH**/ ?>