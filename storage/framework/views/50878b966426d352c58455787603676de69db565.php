                ...
                <div class=" row">
                    ...
                    <div class=" col s12 m3">
                        <div class=" card-action" style="text-align: center">
                            ...
                            <a href="<?php echo e(url("/")); ?>/uploads/<?php echo e($vals->getStudentDetail->username.'/'.$valAttch->attachment_link); ?>" target="_blank" class="waves-effect waves-light btn" style="background-color: #736cb5;">Download</a>
                        </div>
                    </div>
...
<?php endif; ?>
<?php /**PATH /home/n614h8do5jis/public_html/V/app/edkonnect1/resources/views/homework/homeworkTutorListDetailView.blade.php ENDPATH**/ ?>