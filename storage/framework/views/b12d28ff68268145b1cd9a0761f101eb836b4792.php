    ...
    <section class="snow-editor">
        <div class="row">
            <div class="col s12">
                ...
                ?>
                <p style="text-align: center;"><a target="_blank" href="<?php echo e(url($vals->homework)); ?>" class="waves-effect waves-light btn" style="background-color: #736cb5;    margin-top: 20px;"><?php echo e(basename($hw)); ?></a></p>
            </div>
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n614h8do5jis/public_html/V/app/edkonnect/resources/views/session/tutorview.blade.php ENDPATH**/ ?>