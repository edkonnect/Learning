...
return [
    'custom' => [
        ...
        'largeScreenLogo' => '', //we used saparete log image for large screen and small
        'smallScreenLogo' => '', // pass the image path here e.g:'images/logo/materialize-logo-color.png' note:(Vertical-menu-nav-dark and horizontal-menu template used a single logo in both small and large screen)
