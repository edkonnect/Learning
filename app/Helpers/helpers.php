...
class Helper {
    ...
    public static function applClasses() {
        ...
        $dataDefault = [
            ...
            'isFooterDark' => null,
            'isFooterFixed' => false,
            'templateTitle' => 'Edkonnect',
            'isCustomizer' => true,
            'defaultLanguage' => 'en',
            'largeScreenLogo' => 'images/logo/logo.png',
        ...
        $layoutClasses = [
            ...
            'templateTitle' => $dataDefault['templateTitle'],
            'isCustomizer' => $data['isCustomizer'],
            'largeScreenLogo' => $dataDefault['largeScreenLogo'],
            'smallScreenLogo' => $dataDefault['smallScreenLogo'],
    ...
    public static function time_elapsed_string($timeCreated, $full = false) {
        $diff = $time = '';
        if (isset($timeCreated)) {
            $timestamp = strtotime($timeCreated);
            ...
            if ($currentTime >= $timestamp) {
                ...
                $diff = round($diff);
                $diff = $diff . " " . $strTime[$i] . "(s) ago ";
            }
            $time = date('H:i A', $timestamp);
            return array('diff' => $diff, 'time' => $time);
        }
    }
